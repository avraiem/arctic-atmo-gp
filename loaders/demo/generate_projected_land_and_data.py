...
def generate_projected_land_and_data():
    ...
    file_path = "data/raw/data_stream-mnth_stepType-avgua1.nc"
    ...
    print("File info:", loader.get_file_info())
    print("File attributes:", loader.get_file_attributes())
    print("File header:", loader.get_header())
    variable_name = loader.get_data_variable_names()[7]
    #values grided
    ...
    plt.pcolormesh(x_grid, y_grid, values_grid, cmap='coolwarm', alpha=0.5, vmin=0.0)
